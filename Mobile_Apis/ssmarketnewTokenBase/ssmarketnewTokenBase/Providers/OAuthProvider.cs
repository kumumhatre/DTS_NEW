...
namespace ssmarketnewTokenBase.Providers
{
    public class OAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            if (!context.OwinContext.Response.Headers.ContainsKey("Access-Control-Allow-Origin"))
                context.OwinContext.Response.Headers.Add("Access-Control-Allow-Origin", new[] { "https://10221975.com", "http://localhost:8000" });
            ...
            return Task.Factory.StartNew(() =>
            {
                ...
                //{
                    ...
                    if (user.message == "No result available in Limits")
                    {
        ...
        public static AuthenticationProperties CreateProperties(userinfo user)
        {
            ...
            {
                { "Message","Success" },
                { "base_Url", "https://10221975.com/SSMarketNew/v1/"},
                { "Clintcode", user.clientcode },
                { "id", user.id },
                { "Name", user.name },
            ...
            return new AuthenticationProperties(result);
        }
        #endregion
    }
}