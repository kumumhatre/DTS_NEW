...
namespace ssmarketnewTokenBase.ClassFiles
{
    public class Limits
    {
        ...
        public Double utilizedMargin { get; set; }
        public int PendingOrderExec { get; set; }
        public int brkg_mcx { get; set; }
        public int brkg_NseFut { get; set; }
        public int brkg_NseCurr { get; set; }
        public int brkg_Ncdex { get; set; }
    }
