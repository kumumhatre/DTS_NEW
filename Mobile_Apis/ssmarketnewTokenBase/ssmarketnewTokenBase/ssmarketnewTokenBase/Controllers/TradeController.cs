    ...
    public class TradeController : ApiController
    {
        ...
        public HttpResponseMessage getPortfolio(string clientcode)
        {
            ...
            else
            {
                ...
                {
                    string[] result = items.Key.Split('_');
                    string symbol = result[0];
                    string account = result[1];
                    int validity = Convert.ToInt32(result[2]);
        ...
        public HttpResponseMessage validateTrade([FromBody] validatetrade vt)
        {
            ...
            if (objord.validity != 1)
            {
                ...
                if (isClosePos == false)
                {
                    ...
                    NetExchLots = (exchlots + ExchPendingLots + objord.qty);
                }
            ...
            else
            {
                ...
                if (isClosePos == false)
                {
                    ...
                    NetExchLots = (exchlots + ExchPendingLots + curcnflots);
                }
