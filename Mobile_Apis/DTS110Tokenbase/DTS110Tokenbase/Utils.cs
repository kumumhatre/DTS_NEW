...
namespace DTS110Tokenbase
{
    public class Utils
    {
        ...
        public static SqlConnection conn = new SqlConnection(@"Data Source=173.212.229.110\M4910\MSSQLSERVER17,49170;User ID=sa;Initial Catalog=DTSNew;Password=Piggy@24;Integrated Security=false;MultipleActiveResultSets = True;Connect Timeout=500000000");
       ...
       // public static SqlConnection feedconn = new SqlConnection(@"Data Source=207.180.255.236\\M11836\\SQLEXPRESS,49170;User ID=jerry;Initial Catalog=DTS;Password=Jerry@((764));Integrated Security=false;MultipleActiveResultSets = True;Connect Timeout=500000000");
        public static SqlConnection feedconn = new SqlConnection(@"Data Source=207.180.220.239\M11339\MSSQLSERVER,1433;User ID=Optimus;Initial Catalog=DTS;Password=Opt#us;Integrated Security=false;MultipleActiveResultSets = True;Connect Timeout=500000000");
