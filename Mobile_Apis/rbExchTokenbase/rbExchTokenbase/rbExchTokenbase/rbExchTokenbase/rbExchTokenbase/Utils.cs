...
namespace rbExchTokenbase
{
    ...
    { 
        ...
        public static SqlConnection conn = new SqlConnection("Data Source=207.180.255.236\\M11836\\SQLEXPRESS,49170;User ID=jerry;Initial Catalog=RBexch;Password=Jerry@((764));Integrated Security=false;MultipleActiveResultSets = True;Connect Timeout=500000000");
        ...
        //Limits GetLimits(string clientcode, SqlConnection conn)
        //{
                ...
                if (objord.accountNo == clientcode.ToLower() || objord.accountNo == clientcode.ToUpper())
                {
                    ...
                    if (objlimits.mrgntype == 1 || objlimits.mrgntype == 4 || objlimits.mrgntype == 6 || objlimits.mrgntype == 7)
                    {
                        if (objord.ExchangeTypeID == 2)
                            ...
                            TurnoverMrgn += objord.Ordeqty * Convert.ToDouble(objord.OrdePrice) * objcon.lotsize;
                    }
